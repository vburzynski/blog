...
function Profile() {
  return (
    <div className="max-w-4xl flex items-center flex-wrap mx-auto my-32 lg:my-0">
      {/* Main Col */}
      <div className="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-canvas opacity-90 mx-6 lg:mx-0">
        <div className="p-4 md:p-12 text-center lg:text-left">
          ...
          <div className="mt-6 pb-16 lg:pb-0 w-4/5 lg:w-full mx-auto flex flex-wrap items-center justify-between">
            <a className="link" href="/" data-tippy-content="@facebook_handle">
              <svg
                className="h-6 fill-current text-primary-800 hover:text-primary"
                role="img"
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
              >
